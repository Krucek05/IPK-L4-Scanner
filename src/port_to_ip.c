...
static int ip_string_from_ipv4(const struct sockaddr_in *address, char *out, size_t out_size) {
...
static int ip_string_from_ipv6(const struct sockaddr_in6 *address, char *out, size_t out_size) {
